                        ...
                        .on("click", function(d,i){
                            ...
                            d3.json('london.json')
                                .then(data => {
                                    ...
                                    svg.append("text").attr("x", 20).attr("y", 30).text("Bourough:").attr("class", "fa").attr("fill", "#FF0000").attr("stroke", "12");
                                    svg.append("text").attr("x", 100).attr("y", 30).text(country.id).style("font-size", "15px").attr("alignment-baseline","middle");
                                    svg.append("text").attr("x", 20).attr("y", 60).text("Deaths:").attr("class", "fa").attr("fill", "#FF0000").attr("stroke", "12");
                                    svg.append("text").attr("x", 100).attr("y", 60).text(boroughKillFreq[country.id]).style("font-size", "15px").attr("alignment-baseline","middle");
